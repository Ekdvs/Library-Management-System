...
namespace sarasavilibrary
{
    public partial class BookRegistration : Form
    {
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            ...
            string borrowingStatus = borrowable_ststus_cmb.SelectedItem.ToString();
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        using (SqlCommand command = new SqlCommand(query, connection))
                        {
                            ...
                            if (reader.Read())
                            {
                                ...
                                borrowable_ststus_cmb.SelectedItem = reader["BorrowingStatus"].ToString();
        ...
        private void ClearBookDetails()
        {
            ...
            title_txt.Clear();
            publisher_txt.Clear();
            borrowable_ststus_cmb.SelectedIndex = -1;
